...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-baa72e6471 (http://hl7.org/fhir/StructureDefinition/AdverseEvent) on 2019-06-25.
...
class AdverseEvent(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("detector", "detector", fhirreference.FHIRReference, True, None, False),
...
class AdverseEventSuspectEntity(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.instanceCodeableConcept = None
        """ Refers to the specific entity that caused the adverse event.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.instanceReference = None
        """ Refers to the specific entity that caused the adverse event.
        Type `FHIRReference` (represented as `dict` in JSON). """
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("instanceCodeableConcept", "instanceCodeableConcept", codeableconcept.CodeableConcept, False, "instance", True),
            ("instanceReference", "instanceReference", fhirreference.FHIRReference, False, "instance", True),
