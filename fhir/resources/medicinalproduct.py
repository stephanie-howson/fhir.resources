...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-baa72e6471 (http://hl7.org/fhir/StructureDefinition/MedicinalProduct) on 2019-06-25.
...
class MedicinalProduct(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ General combined description of indication(s) for this product. See
        also MedicinalProductIndication.
        Type `str`. """
        ...
        List of `MedicinalProductContact` items (represented as `dict` in JSON). """
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("contact", "contact", MedicinalProductContact, True, None, False),
...
class MedicinalProductContact(backboneelement.BackboneElement):
    """ A product specific contact, person (in a role), or an organization.
    """
    
    resource_type = "MedicinalProductContact"
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        Pharmacovigilence Enquiry Information.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        ...
        super(MedicinalProductContact, self).__init__(jsondict=jsondict, strict=strict)
    
    def elementProperties(self):
        js = super(MedicinalProductContact, self).elementProperties()
        js.extend([
            ("type", "type", codeableconcept.CodeableConcept, False, None, False),
