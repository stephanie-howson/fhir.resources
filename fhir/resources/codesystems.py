...
class MedicationStatementStatusCodes(object) {
...
class MedicationStatementCategoryCodes(object) {
	""" MedicationStatement Category Codes
...
class ClinicalProfileCohortAxis(object) {
	""" The axis used to stratify the cohort.

	URL: http://terminology.hl7.org/CodeSystem/profile-cohort-axis
	ValueSet: http://hl7.org/fhir/ValueSet/profile-cohort-axis
	"""
...
class ClinicalProfileStatus(object) {
	""" The status of the clinical profile.

	URL: http://hl7.org/fhir/clinical-profile-status
	ValueSet: http://hl7.org/fhir/ValueSet/clinical-profile-status
	"""
