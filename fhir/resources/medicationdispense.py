...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-baa72e6471 (http://hl7.org/fhir/StructureDefinition/MedicationDispense) on 2019-06-25.
...
class MedicationDispenseSubstitution(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("responsibleParty", "responsibleParty", fhirreference.FHIRReference, False, None, False),
        ])
        return js
